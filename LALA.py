...
#User Agnes buatan Asep Yusup 
    ...
    empat  = f"Mozilla/5.0 (Linux; Android 12; SM-S908U1 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/100.0.4896.88 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/377.0.0.22.107;]"
...
def mainx():
    ...
    if LALA in ["1","01"]:
     ...
     os.system("xdg-open https://www.facebook.com/THE.KING.OF.FACEBOOK.LALA.IMRAN.BALOCH.786");mainx()
    elif LALA in ["0","00"]:
     print(f'{gen}{RED}Exited {H}FB-LALA {P}Terminal ');os.system("xdg-open https://www.facebook.com/THE.KING.OF.FACEBOOK.LALA.IMRAN.BALOCH.786");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.LALA.cyber/?ref=share');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/THE.KING.OF.FACEBOOK.LALA.IMRAN.BALOCH.786");mainx()
def mainx2():
    os.system("clear")
    banner()
...
useragent = ('Mozilla/5.0 (Linux; Android 12; SM-S908U1 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/100.0.4896.88 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/377.0.0.22.107;]'.format(android_version1, android_model1, build1, browser_version1))
...
def m1(idf,pwv):
    ...
    rr = random.randint
    rc = random.choice
    ugen1 = f"Mozilla/5.0 (Linux; Android 12; SM-S908U1 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/100.0.4896.88 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/377.0.0.22.107;]"
 ...
 # gif = random.choice(["\x1b[1;91m•    ","\x1b[1;92m••   ","\x1b[1;93m•••  ","\x1b[1;94m•••• ","\x1b[1;95m•••••"])
  ...
  for pw in pwv:
    try:
      ...
      "user-agent": ua, #'Mozilla/5.0 (Linux; Android 12; SM-S908U1 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/100.0.4896.88 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/377.0.0.22.107;],
      "accept": "*/*",
...
ua = f"Mozilla/5.0 (Linux; Android 12; SM-S908U1 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/100.0.4896.88 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/377.0.0.22.107;]"
